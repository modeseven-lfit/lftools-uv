...
@click.option("--teams", is_flag=True, required=False, help="List available teams")
...
@click.option("--admin", is_flag=True, required=False, help="User is admin for org, or a maintainer of a team")
@click.pass_context
